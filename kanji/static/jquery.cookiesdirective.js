...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			cookiePolicyUri: 'cookiepolicy.php',
	...
	var disclosure = function(options) {
		...
		if(!settings.message) {
			if(settings.explicitConsent) {
				...
				settings.message = 'By using this website, you consent to the use of cookies in accordance with the CapCon Engineering Cookie Policy.';
			}		
		}	
