...
;(function($) {
	$.cookiesDirective = function(options) {
		...
		var settings = $.extend({
			...
			message: null,				
			cookieScripts: null,
			privacyPolicyUri: '../templates/privacypolicy.php',
			cookiePolicyUri: '../templates/cookiepolicy.php',
	...
	var disclosure = function(options) {
		...
		if(!settings.message) {
			if(settings.explicitConsent) {
				...
				settings.message = 'By using this website, you consent to the use of cookies in accordance with the FlashBang Site Cookie Policy.';
			}		
		}	
